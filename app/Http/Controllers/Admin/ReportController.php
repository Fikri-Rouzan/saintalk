...
class ReportController extends Controller
{
    ...
    public function store(StoreReportRequest $request)
    {
        ...
        Swal::toast('Report Data Successfully Added', 'success')->timerProgressBar();
    ...
    public function update(UpdateReportRequest $request, string $id)
    {
        ...
        Swal::toast('Report Data Successfully Updated', 'success')->timerProgressBar();
    ...
    public function destroy(string $id)
    {
        ...
        Swal::toast('Report Data Successfully Deleted', 'success')->timerProgressBar();
