...
class ReportStatusController extends Controller
{
    ...
    public function store(StoreReportStatusRequest $request)
    {
        ...
        Swal::toast('Report Progress Data Successfully Added', 'success')->timerProgressBar();
    ...
    public function update(UpdateReportStatusRequest $request, string $id)
    {
        ...
        Swal::toast('Report Progress Data Successfully Updated', 'success')->timerProgressBar();
    ...
    public function destroy(string $id)
    {
        ...
        Swal::toast('Report Progress Data Successfully Deleted', 'success')->timerProgressBar();
