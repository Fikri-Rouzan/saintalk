...
class ReportCategoryController extends Controller
{
    ...
    public function store(StoreReportCategoryRequest $request)
    {
        ...
        Swal::toast('Category Data Successfully Added', 'success')->timerProgressBar();
    ...
    public function update(UpdateReportCategoryRequest $request, string $id)
    {
        ...
        Swal::toast('Category Data Successfully Updated', 'success')->timerProgressBar();
    ...
    public function destroy(string $id)
    {
        ...
        Swal::toast('Category Data Successfully Deleted', 'success')->timerProgressBar();
