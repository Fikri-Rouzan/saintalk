...
class ResidentController extends Controller
{
    ...
    public function store(StoreResidentRequest $request)
    {
        ...
        Swal::toast('FST UIN JKT Resident Data Successfully Added', 'success')->timerProgressBar();
    ...
    public function update(UpdateResidentRequest $request, string $id)
    {
        ...
        Swal::toast('FST UIN JKT Resident Data Successfully Updated', 'success')->timerProgressBar();
    ...
    public function destroy(string $id)
    {
        ...
        Swal::toast('FST UIN JKT Resident Data Successfully Deleted', 'success')->timerProgressBar();
